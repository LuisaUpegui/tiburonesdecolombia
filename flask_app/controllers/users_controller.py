...
def edit_user(id):
    ...
    formulario_magazines = { "id": id }
    magazines = Magazine.get_user_magazines(formulario_magazines)

    return render_template('edit_user.html', user=user, magazines=magazines )
